package com.microsoft.cosmosdb.gremlinx.io;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.microsoft.cosmosdb.gremlinx.gremlin.GenericNode;
...
public class FileUtil {
    ...
    public List<HashMap> readJsonList(String infile) throws Exception {

        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(Paths.get(infile).toFile(), List.class);
    }

    public ArrayList<GenericNode> readGenericNodes(String infile) throws Exception {

        // https://www.baeldung.com/java-super-type-tokens
        // https://www.programcreek.com/java-api-examples/?api=com.fasterxml.jackson.core.type.TypeReference

        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(Paths.get(infile).toFile(), new TypeReference<ArrayList<GenericNode>>() {});
    }
